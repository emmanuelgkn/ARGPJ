...
# /Users/emmanuel/Documents/M1/S2/PLDAC/ARGPJ/src/runs

class GetInformations:
    def __init__(self,env,nbeps,model,epsilon = 1,alpha=.7,gamma = 0.95):
        self.triplets = []
        self.qvalues = []
...
class train:
    def __init__(self,env,nIter,epsilon = 1,state_dim=4):
        self.nIter = nIter
